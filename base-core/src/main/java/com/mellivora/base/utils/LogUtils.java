...
import com.mellivora.base.expansion.JsonExtKt;
...
public final class LogUtils {
    ...
    private static TagHead processTagAndHead(String tag) {
        if (!CONFIG.mTagIsSpace && !CONFIG.isLogHeadSwitch()) {
            ...
            if (stackIndex >= stackTrace.length) {
                ...
                if (CONFIG.mTagIsSpace && CharSequenceExpansionKt.isSpace(tag)) {
    ...
    public static final class Config {
        ...
        private String                  mProcessName       = ProcessUtils.INSTANCE.getCurrentProcessName();
        ...
        private Utils.FileHead mFileHead          = new Utils.FileHead("Log");
        ...
        public final Config setGlobalTag(final String tag) {
            if (CharSequenceExpansionKt.isSpace(tag)) {
                mGlobalTag = "";
                mTagIsSpace = true;
            } else {
                mGlobalTag = tag;
        ...
        public final Config setDir(final String dir) {
            if (CharSequenceExpansionKt.isSpace(dir)) {
                mDir = null;
            } else {
        ...
        public final Config setFilePrefix(final String filePrefix) {
            if (CharSequenceExpansionKt.isSpace(filePrefix)) {
                mFilePrefix = "util";
            } else {
        ...
        public final Config setFileExtension(final String fileExtension) {
            if (CharSequenceExpansionKt.isSpace(fileExtension)) {
                mFileExtension = ".txt";
            } else {
        ...
        public final String getGlobalTag() {
            if (CharSequenceExpansionKt.isSpace(mGlobalTag)) return "";
            return mGlobalTag;
        }
    ...
    private final static class LogFormatter {
        ...
        private static String object2Json(Object object) {
            ...
            try {
                return JsonExtKt.toJson(object);
            } catch (Throwable t) {
                return object.toString();
            }
        }
