...
package com.mellivora.base.binding.ui.widget.keyboard.callback
 ...
 * @param isFullMode: Whether the current UI is in full screen mode
 */
class RootViewDeferringInsetsCallback(
    ...
    override fun onApplyWindowInsets(
        ...
        val systemBarVisible = windowInsets.isVisible(
            WindowInsetsCompat.Type.statusBars() or WindowInsetsCompat.Type.captionBar()
        )
        val topInsets = if(systemBarVisible) typeInsets.top else 0
        v.setPadding(typeInsets.left, topInsets, typeInsets.right, typeInsets.bottom)
